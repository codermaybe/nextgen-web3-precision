...
// 于2025/7/8 引入此外部拓展库 因为 BigNumber.js 9.1.2 (当前版本）没有 ln() 方法
// 官方链接：https://r-knott.surrey.ac.uk/BigNumberLIB/bignumberLIB.js
// 官方文档：https://r-knott.surrey.ac.uk/BigNumberLIB/index.html
var BigNumber = require('bignumber.js'); //自行添加此行，其余部分丝毫未动
...
function(){var x,z;
  ...
  {  if(x=fibBNmemo[this.toNumber()])return x;
	  if(this.isNegative()){x= this.negated().fib();if(this.negated().mod(2n).isZero())x=x.negated();return x}
